...
class User(UserMixin, db.Model):
    ...
    country_of_origin = db.Column(db.String(150), nullable=False)
    question_a = db.Column(db.Integer, nullable=False)
    signal_line = db.Column(db.Integer, default=1)
    results = db.relationship('Result', backref='user', lazy=True)
    access_times = db.relationship('AccessTime', backref='user', lazy=True)
...
class Result(db.Model):
    ...
    signal_line = db.Column(db.Integer, nullable=False)
